...
def construct_query_dict(df_centroids, base_path, save_path, filename, ind_nn_r, ind_r_r=50):
...
if __name__ == '__main__':
    ...
    construct_query_dict(df_train, base_path, args.save_path, "training_queries_baseline.pickle", ind_nn_r=10)
    construct_query_dict(df_test, base_path, args.save_path, "test_queries_baseline.pickle", ind_nn_r=10)
