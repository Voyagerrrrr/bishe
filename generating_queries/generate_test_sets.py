...
def construct_query_and_database_sets(base_path, save_path, runs_folder, folders, pointcloud_fols, filename, p, output_name):
    database_trees = []
    test_trees = []
    ...
    output_to_file(database_sets, save_path, output_name + '_evaluation_database.pickle')
    output_to_file(test_sets, save_path, output_name + '_evaluation_query.pickle')
...
if __name__ == '__main__':
    ...
    print(folders)
    construct_query_and_database_sets(base_path, save_path, runs_folder, folders, "/pointcloud_20m/",
    ...
    print(folders)
    construct_query_and_database_sets(base_path, save_path, runs_folder, folders, "/pointcloud_25m_25/",
